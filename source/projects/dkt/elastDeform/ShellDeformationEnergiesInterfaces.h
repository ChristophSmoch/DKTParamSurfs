...
: public pesopt::NonlinearEnergyOp<typename MatOptConfType::ConfiguratorType::DTContainer>
{
 ...
 public:
  ...
  void evaluateHessian( const VectorType &Disp, SparseMatrixType &Hessian ) const {
  ...
  void evaluateTripletListHessian( const VectorType &Disp, std::vector<TripletType> & tripletList ) const {
    this->asImp().assembleTripletListHessian( Disp, tripletList );  
  }
  
  void evaluateTripletListHessianSym( const VectorType &Disp, std::vector<TripletType> & tripletListSym ) const {
